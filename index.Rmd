...
* Write a project proposal of half a page that contains:
    ...
    * Task 2: How? Describe methodology and data set
        ...
        * Can you access it via a script?
    * Task 3: What will be the result, output, and/or visualisation

* Submit your project proposal to GitLab before 1630u today so the the other team can review.
* Submit as a short readable structured text file (i.e. .txt format)
