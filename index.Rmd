...
2. A project, repository, that is reproducible and produces a result (map, analysis) for your presentation
* If you have external data, put the data files on MS Teams (**NOT** in your Git repository!)
3. An interactive pitch demonstration of your work where you explain:
* objective
* workflow
...
* Submit your proposal **before Wednesday September 30, 18:00**
